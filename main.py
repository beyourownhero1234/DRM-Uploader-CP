...
credit ="😎𝖘:)™~" 
OWNER = int(os.environ.get("OWNER", 1760032652))
try: 
    ADMINS=[] 
    for x in (os.environ.get("ADMINS", "1760032652").split()):  
        ADMINS.append(int(x)) 
except ValueError: 
...
bot = Client("bot",    
   bot_token="7920585446:AAEQO3cOD0VJGa9G-tOuCbAD0txrCtUauao",    
   api_id= 20870930,    
   api_hash= "d8339c188abe7b852e52ef2d0d48c770"
)
